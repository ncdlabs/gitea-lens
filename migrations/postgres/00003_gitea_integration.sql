...
-- +goose Down
ALTER TABLE app_settings DROP COLUMN IF EXISTS gitea_url;
ALTER TABLE app_settings DROP COLUMN IF EXISTS gitea_token_cipher;
ALTER TABLE app_settings DROP COLUMN IF EXISTS gitea_webhook_secret_cipher;
ALTER TABLE app_settings DROP COLUMN IF EXISTS gitea_allow_private_network;
ALTER TABLE app_settings DROP COLUMN IF EXISTS gitea_allow_unsigned_webhooks;
ALTER TABLE app_settings DROP COLUMN IF EXISTS oauth_client_id;
ALTER TABLE app_settings DROP COLUMN IF EXISTS oauth_client_secret_cipher;
ALTER TABLE app_settings DROP COLUMN IF EXISTS setup_completed;
